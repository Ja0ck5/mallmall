...
<head>
    ...
    <title>登录MALLMALL</title>
    <link type="text/css" rel="stylesheet" href="http://static.mallmall.com/css/login.css"/>
    <script type="text/javascript" src="http://static.mallmall.com/js/jquery-1.2.6.min.js"></script>
    <script type="text/javascript" src="http://static.mallmall.com/js/login/g.base.js"></script>
   	<script type="text/javascript" src="http://static.mallmall.com/js/login/jdEdit.js"></script>
...
<div class="w">
    <div id="logo">
    	<a href="http://www.mallmall.com/" clstag="passport|keycount|login|01">
    		<img src="http://static.mallmall.com/images/taotao-logo.gif" alt="MallMall" width="170" height="60"/>
    	</a><b></b>
   	</div>
</div>
<form id="formlogin" method="post" onsubmit="return false;">
    ...
    <div class=" w1" id="entry">
        <div class="mc " id="bgDiv">
            <div id="entry-bg" clstag="passport|keycount|login|02" style="width: 511px; height: 455px; position: absolute; left: -44px; top: -44px; background: url(http://static.mallmall.com/images/544a11d3Na5a3d566.png) 0px 0px no-repeat;">
			</div>
            <div class="form ">
        ...
        <div class="free-regist">
            <span><a href="http://sso.mallmall.com/register.html" clstag="passport|keycount|login|08">免费注册&gt;&gt;</a></span>
        </div>
    </div>
</form>
<div class="w1">
...
<script type="text/javascript" src="http://static.mallmall.com/js/login/login.js"></script>
<script type="text/javascript" src="http://static.mallmall.com/js/login/jdThickBox.js"></script>
<script type="text/javascript" src="http://static.mallmall.com/js/login/checkClient.js"></script>
<script>
