...
<link type="text/css" rel="stylesheet"
	href="http://static.mallmall.com/css/regist.personal.css" />
<link type="text/css" rel="stylesheet"
	href="http://static.mallmall.com/css/passport.base.css" />
<script type="text/javascript"
	src="http://static.mallmall.com/js/jquery-1.2.6.min.js"></script>
</head>
<body>
	<script type="text/javascript">
function login() {
...
function addToFavorite() {
	...
	<div class="w" id="logo">
		<div>
			<a href="http://www.mallmall.com/"> <img
				src="http://static.mallmall.com/images/taotao-logo.gif" alt="京东商城"
				width="170" height="60" />
			</a> <b></b>
		</div>
	</div>
		...
		<div class="mt">
			...
			<div class="extra">
				<span style="text-align: right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a
					...
					href="http://sso.mallmall.com/login.html" class="flk13">登录</a></span>
			</div>
		</div>
		<div class="mc">
			<form id="personRegForm" method="post" onsubmit="return false;">
					...
					<div id="o-password">
						<div class="item">
							...
							<div class="fl item-ifo">
								...
								<label id="pwd_error"></label> <span class="clr"></span> <label
				...
				<div class="phone">
					<img width="180" height="180"
						src="http://static.mallmall.com/images/phone-bg.jpg">
				</div>
				<span class="clr"></span>
			</form>
		</div>
	...
	<script type="text/javascript"
		src="http://static.mallmall.com/js/register/jd.lib.js"></script>
	<script type="text/javascript"
		src="http://static.mallmall.com/js/register/jdThickBox.js"></script>
	<script type="text/javascript"
		src="http://static.mallmall.com/js/register/jdValidate.js"></script>
	<script type="text/javascript"
		src="http://static.mallmall.com/js/register/jdValidate.emReg.js"></script>
	<script type="text/javascript"
		src="http://static.mallmall.com/js/register/jdValidate.regSuccess.js"></script>
