...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
   ...
   <link rel="stylesheet" href="http://static.mallmall.com/css/base.css">
   <link href="http://static.mallmall.com/css/purchase.2012.css?v=201410141639" rel="stylesheet" type="text/css">
   <title>我的购物车 - MALLMALL商城</title>
   <script>
   	var pageConfig  = {};
   </script>
<body> 
...
<div class="w w1 header clearfix">
	<div id="logo"><a href="http://www.mallmall.com/"><img clstag="clickcart|keycount|xincart|logo" src="http://static.mallmall.com/images/taotao-logo.gif" title="返回MALLMALL商城首页" alt="返回MALLMALL商城首页"></a></div>
	        ...
	        <div id="product_11345721" data-bind="rowid:1" class="item item_selected ">
		        <div class="item_form clearfix">
		            ...
		            <div class="cell p-goods">
		                <div class="p-img">
		                	<a href="http://www.mallmall.com/item/${cart.itemId }.html" target="_blank">
		                		<img clstag="clickcart|keycount|xincart|p-imglistcart" src="${cart.itemImage}" alt="${cart.itemTitle}" width="52" height="52">
		                	</a>
		                </div>    
		                <div class="p-name">
		                	<a href="http://www.mallmall.com/item/${cart.itemId }.html" clstag="clickcart|keycount|xincart|productnamelink" target="_blank">${cart.itemTitle}</a>
		            ...
		            <div class="cell p-remove"><a id="remove-11345721-1" data-more="removed-87.20-1" clstag="clickcart|keycount|xincart|btndel318558" class="cart-remove" href="http://cart.mallmall.com/delete/${cart.itemId}.html">删除</a>
		            </div>
		        </div>
	        </div> 
        </c:forEach>
        ...
        <div class="ui-ceilinglamp-1" style="width: 988px; height: 49px;"><div class="cart-dibu ui-ceilinglamp-current" style="width: 988px; height: 49px;">
          <div class="control fdibu fdibucurrent">
              ...
              <span class="shopping">
                  ...
                  <a href="http://www.mallmall.com/" target="_blank" clstag="clickcart|keycount|xincart|coudanlink" id="continue">继续购物</a>
              </span>
          </div>
...
<script type="text/javascript" src="http://static.mallmall.com/js/base-v1.js"></script>
<!-- footer start -->
<jsp:include page="../commons/footer.jsp" />
<!-- footer end -->

<!-- 购物车相关业务 -->
<script type="text/javascript" src="http://static.mallmall.com/js/cart.js"></script>
<script type="text/javascript" src="http://static.mallmall.com/js/jquery.price_format.2.0.min.js"></script>
